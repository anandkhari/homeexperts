      ...
      <section className="bg-[#F8FAFC] px-4 py-16 md:px-6 md:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mb-12 text-center md:mb-20">
            ...
            <h2 className="text-3xl font-medium leading-snug tracking-tight text-[#2C3E6B] md:text-4xl lg:text-5xl">
              What you get from our <br className="hidden sm:block" />
          ...
          {/* Feature cards */}
          <div className="mb-12 grid grid-cols-1 gap-5 sm:grid-cols-2 md:mb-16 md:gap-8">
            {commercialFeatures.map((item) => (
              <div
                key={item.title}
                className="group rounded-3xl border border-gray-100 bg-white p-6 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl md:rounded-[2.5rem] md:p-10"
              >
                {/* Mobile: icon on top, Desktop: icon left */}
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:gap-6">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-2xl bg-[#2C3E6B] text-[#3BBFBF] transition-colors group-hover:bg-[#3BBFBF] group-hover:text-white md:h-14 md:w-14">
                    {item.icon}
                  </div>
                  <div>
                    <h3 className="mb-2 text-base font-black uppercase tracking-tight text-[#2C3E6B] md:mb-3 md:text-xl">
                      {item.title}
                    </h3>
          ...
          {/* FAQ section */}
          <section className="relative mt-16 overflow-hidden rounded-3xl bg-[#2C3E6B] px-5 py-14 text-white md:mt-24 md:rounded-[3rem] md:px-10 md:py-18">
            ...
            <div className="relative z-10 mx-auto max-w-6xl">
              <div className="mb-8 text-center md:mb-14">
                ...
                <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-[#3BBFBF] md:mt-6 md:w-32" />
              </div>
                  ...
                  return (
                    <div key={faq.question}>
                      <button
                        ...
                        className="flex w-full items-start gap-3 py-5 text-left md:items-center md:gap-4"
                      >
                        <ChevronRight
                          className={`mt-0.5 h-4 w-4 flex-shrink-0 text-[#3BBFBF] transition-transform duration-300 md:mt-0 ${
                            isOpen ? "rotate-90" : ""
                          }`}
                        />
                        <span className="text-sm font-black leading-snug text-white md:text-lg">
                          {faq.question}
                        </span>
                      </button>

                      {isOpen && (
                        <div className="pb-5 pl-7 pr-2 md:pl-8">

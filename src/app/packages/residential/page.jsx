...
const features = [
  {
    ...
    description: "Our contract includes highly convenient, around-the-clock emergency support for any AC, plumbing, or electrical issues that arise throughout the year, 365 days a year.",
    icon: <Clock className="h-6 w-6" />,
  },
  {
    title: "Air Conditioner Maintenance",
    description: "Our comprehensive 14-step AC inspection includes full assessment, disinfection, and troubleshooting performed quarterly to ensure peak efficiency during UAE summers.",
    icon: <Wind className="h-6 w-6" />,
  },
  {
    title: "Electrical Inspections",
    description: "Certified technicians perform annual checks for loose wiring, overloaded circuits, and fire risks, remaining on standby for ad-hoc repairs and emergency issues.",
    icon: <Zap className="h-6 w-6" />,
  },
  {
    title: "Plumbing Inspections",
    description: "Thorough annual inspections check for hidden leaks, clogged drains, faulty fixtures, and water pressure issues. Ad-hoc plumbing repairs are fully covered.",
...
const faqs = [
  ...
  {
    question: "Why aren't duct and coil cleaning included in the residential AMC?",
    answer:
  ...
  {
    question: "Are all household plumbing and electrical issues covered under the contract?",
    answer:
  ...
  {
    question: "Aren't contracts just a way for companies to charge more for unnecessary add-ons?",
    answer:
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="lg:col-span-7">
            ...
            <h2 className="mb-8 text-4xl font-medium leading-[1.1] tracking-tight text-[#2C3E6B] md:text-5xl  uppercase">
              Essential AMC <span className="text-[#3BBFBF]">Contract Dubai</span> — 24/7 Support
            </h2>

            <div className="space-y-6 text-base leading-relaxed text-[#5A6A8A] md:text-lg">
              <p>
                At <span className="font-bold text-[#2C3E6B]">Home Experts UAE</span>, your peace of mind is our priority. 
                We have developed a comprehensive, cost-saving annual maintenance contract 
                designed for Dubai homeowners that covers all your essential property needs.
              </p>
              
              <p>
                With year-round AC servicing and 24-hour qualified support for plumbing and 
                electrical repairs, our Essential Maintenance package is the gold standard 
                for home care. Our highly-skilled team of certified technicians is on-hand 
                365 days a year to deliver precision workmanship and emergency assistance.
              </p>

              {/* NEW HIGHLIGHT BOX */}
              <div className="rounded-2xl border-l-4 border-[#3BBFBF] bg-[#F8FAFC] p-6 shadow-sm">
                <p className="text-sm font-bold text-[#2C3E6B]">
                  <span className="text-[#3BBFBF] uppercase tracking-widest text-[10px] block mb-2">New for 2026</span>
                  Our new <span className="text-[#3BBFBF]">Essential Maintenance Inclusive</span> package 
                  now includes everything in the standard contract <span className="italic">plus all your AC parts coverage.</span>
                </p>
              </div>
            </div>
          ...
          <div className="relative lg:col-span-5">
            ...
            <div className="relative aspect-[4/5] overflow-hidden rounded-[2.5rem] border-8 border-white shadow-2xl md:aspect-square lg:aspect-[4/5]">
              ...
              <div className="absolute bottom-8 left-8 right-8 rounded-2xl bg-[#2C3E6B]/90 p-6 text-white backdrop-blur-md">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-[#3BBFBF]">Certified Care</div>
                    <div className="text-sm font-bold">100% Parts & Labor Guarantee</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -right-4 top-10 flex h-20 w-20 items-center justify-center rounded-full bg-[#3BBFBF] text-white shadow-xl">
              <div className="text-center">
                ...
                <span className="block text-[10px] font-black leading-none">24/7</span>
              </div>
            </div>
          </div>
      ...
      <section className="bg-[#F8FAFC] py-24 px-6">
        ...
        <div className="text-center mb-20">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-[#3BBFBF] text-[10px] font-black uppercase tracking-[0.4em]">Comprehensive Care</span>
            <span className="h-1 w-8 bg-[#3BBFBF] rounded-full" />
          </div>
          <h2 className="text-4xl md:text-5xl font-black text-[#2C3E6B] uppercase tracking-tight leading-none">
            What is included in our <br />
            <span className="text-[#3BBFBF]">Annual Maintenance Contract?</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {features.map((item, index) => (
            <div 
              key={index}
              className="group bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-1"
            >
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 h-14 w-14 rounded-2xl bg-[#2C3E6B] text-[#3BBFBF] flex items-center justify-center transition-colors group-hover:bg-[#3BBFBF] group-hover:text-white">
                  {item.icon}
                </div>
                <div>

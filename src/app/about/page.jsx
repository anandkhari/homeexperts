...
import { Handshake, Clock4, Award, FileText, HeartHandshake, ShieldCheck, Zap, Heart } from "lucide-react";
  ...
  return (
    <main>
      <PageHero
        ...
        image="https://images.pexels.com/photos/8470036/pexels-photo-8470036.jpeg"
        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-12">
          ...
          <div className="relative aspect-square lg:col-span-5">
            ...
            <div className="absolute -bottom-8 -left-8 rounded-2xl bg-white p-6 shadow-2xl">
              <span className="text-4xl font-black text-[#2C3E6B]">Est. 2008</span>
          ...
          <div className="lg:col-span-7 lg:pl-16">
            ...
            <h2 className="mt-2 mb-10 text-4xl font-medium leading-[1.1] tracking-tight text-[#2C3E6B] md:text-5xl">
              Built on trust, grown through service
            </h2>

            <div className="space-y-6 max-w-2xl text-[0.95rem] leading-[1.75] text-[#2C3E6B]/65">
              <p>
                Founded in 2008, Home Experts UAE is a premium home maintenance company.
                Our journey began with a simple mission: to provide the highest quality
                technical and support services at the most cost-efficient rates.
              </p>
              <p>
                Over the years, we have built an unwavering reputation based on trust,
                reliability, and a commitment to getting the job right the first time.
                Today, we continue to innovate, ensuring every customer experiences total
                peace of mind.
              </p>
            </div>
              ...
              {milestones.map((milestone) => (
                <div key={milestone.year} className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    {milestone.label && (
                      <p className="text-xs text-[#2C3E6B]/65">{milestone.label}</p>
                    )}
                  </div>
                </div>
              ))}
          ...
          {values.map((value, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-start gap-3 pl-[18px]">
                  <value.icon className="h-8 w-8 text-[#3BBFBF]" />

        ...
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            ...
            <div className="mt-10 flex flex-wrap gap-3">
              ...
              <Link
                href="/reviews"
                className="inline-flex items-center justify-center rounded-full border-2 border-[#2C3E6B] px-7 py-3 text-[0.82rem] font-extrabold uppercase tracking-[0.1em] text-[#2C3E6B] transition hover:bg-[#2C3E6B] hover:text-white"
              >
                Client Reviews
              </Link>
            </div>
          ...
          <div className="relative">
            ...
            {/* Teal accent bar */}
            <div className="absolute -left-3 top-10 h-24 w-1 rounded-full bg-[#3BBFBF]" />
            ...
            <div className="relative overflow-hidden rounded-[24px] shadow-[0_24px_64px_rgba(44,62,107,0.14)]">
              <img
                ...
                className="h-[520px] w-full object-cover object-top transition duration-700 hover:scale-[1.02]"
              />

              {/* Floating stat badge */}
              <div className="absolute bottom-6 left-6 rounded-2xl border border-white/20 bg-[#2C3E6B]/90 px-5 py-4 backdrop-blur-sm">
